...
enableParedit = (subs, views) ->
  ...
  utils.addCommands [
    ...
    ["kill-forwards",        edit.killForwards]
    ["kill-backwards",       edit.killBackwards]
    ...
    ["select-forward-sexp",  nav.selectForwardSexp]
    ["select-backward-sexp", nav.selectBackwardSexp]
    ["select-up-sexp",       nav.selectUpSexp]
    ["select-down-sexp",     nav.selectDownSexp]
